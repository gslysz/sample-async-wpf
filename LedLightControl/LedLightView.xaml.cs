...
namespace LedLightControl
{
    ...
    public partial class LedLightView : UserControl
    {
        ...
        private readonly Color _defaultFillColor = Colors.Green;
        private readonly Color _defaultLedBorderColor = Colors.Black;
        private readonly double _defaultLedBorderWidth = 10;
